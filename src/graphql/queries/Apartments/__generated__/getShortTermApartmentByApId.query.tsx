...
export type GetShortTermRentByApIdVariables = Types.Exact<{
  id: Types.FindShortTermRentAdRequest;
}>;

export type GetShortTermRentByApId = {
  __typename: 'Query';
  rentAd__find_shortTermAdByApartmentId?: {
...
export const GetShortTermRentByApIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetShortTermRentByApId' },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'rentAd__find_shortTermAdByApartmentId' },
            arguments: [
              {
                kind: 'Argument',
...
/**
 * __useGetShortTermRentByApId__
 *
 * To run a query within a React component, call `useGetShortTermRentByApId` and pass it any options that fit your needs.
 * When your component renders, `useGetShortTermRentByApId` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetShortTermRentByApId({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetShortTermRentByApId(
  baseOptions: Apollo.QueryHookOptions<GetShortTermRentByApId, GetShortTermRentByApIdVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetShortTermRentByApId, GetShortTermRentByApIdVariables>(
    GetShortTermRentByApIdDocument,
    options,
  );
}
export function useGetShortTermRentByApIdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetShortTermRentByApId, GetShortTermRentByApIdVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetShortTermRentByApId, GetShortTermRentByApIdVariables>(
    GetShortTermRentByApIdDocument,
    options,
  );
}
export type GetShortTermRentByApIdHookResult = ReturnType<typeof useGetShortTermRentByApId>;
export type GetShortTermRentByApIdLazyQueryHookResult = ReturnType<typeof useGetShortTermRentByApIdLazyQuery>;
export type GetShortTermRentByApIdQueryResult = Apollo.QueryResult<
  GetShortTermRentByApId,
  GetShortTermRentByApIdVariables
>;
